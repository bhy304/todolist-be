...
const createTeam = (req, res) => {
  ...
  pool.query(sql, [teamname, userId], (err, results) => {
    ...
    pool.query(memberSql, [results.insertId, userId], err => {
      if (err) {
        console.log(err);
        return res.status(StatusCodes.INTERNAL_SERVER_ERROR).json({
          success: false,
...
const deleteTeam = (req, res) => {
  ...
  pool.query(ownerCheckSql, [teamId], (err, checkResult) => {
    if (err) {
      console.log(err);
      return res.status(StatusCodes.INTERNAL_SERVER_ERROR).json({
        success: false,
    ...
    pool.query(sql, [teamId, userId], (err, results) => {
      if (err) {
        console.log(err);
        return res.status(StatusCodes.INTERNAL_SERVER_ERROR).json({
          success: false,
...
const inviteTeamMember = (req, res) => {
  ...
  pool.query(sql, [username, teamId, userId], (err, results) => {
    if (err) {
      console.log(err);
      return res.status(StatusCodes.INTERNAL_SERVER_ERROR).json({
        success: false,
...
const deleteTeamMember = (req, res) => {
  ...
  pool.query(checkSql, [teamId, memberId], (err, results) => {
    if (err) {
      console.log(err);
      return res.status(StatusCodes.INTERNAL_SERVER_ERROR).json({
        success: false,
    ...
    pool.query(deleteSql, [memberInfo.member_id], err => {
      if (err) {
        console.log(err);
        return res.status(StatusCodes.INTERNAL_SERVER_ERROR).json({
          success: false,
...
const getTeamMembers = (req, res) => {
  ...
  const checkSql = `SELECT * FROM team_members 
                    WHERE teams_id = ? AND users_id = ?`;

  pool.query(checkSql, [teamId, userId], (err, membership) => {
    if (err) {
      console.log(err);
      return res.status(StatusCodes.INTERNAL_SERVER_ERROR).json({
        success: false,
